...
| [`clip-to-reel`](./clip-to-reel/) | Turns any spoken passage of a long video (talking head, screen recording with a webcam bubble, podcast) into a finished 9:16 explainer reel in a proven creator style: cuts only on transcription-verified silences, face tracking, paper split screens, UI-mock scenes, heavy caption chips, snap-zoom cuts with SFX, a music bed and a keyword CTA card. Rendered with HyperFrames and scored by an independent judge agent against a reference reel. | ✅ Stable |
